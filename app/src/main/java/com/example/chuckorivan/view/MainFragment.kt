...
import com.example.chuckorivan.R
import com.example.chuckorivan.adapter.JokeAdapter
import com.example.chuckorivan.databinding.FragmentMainBinding
import com.example.chuckorivan.network.Results
import com.example.chuckorivan.utils.JokeBoxDismiss
import com.example.chuckorivan.utils.fixSpecialChars
            ...
            when (it) {
                ...
                is Results.SUCCESS -> {
                    ...
                    if (it.response.count() == 1) {
                        JokeBoxDismiss.speak(requireContext(),
